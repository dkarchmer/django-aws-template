...
docker run --rm -v ${PWD}/webapp:/var/app/webapp -t ebapp/builder rm -rf /var/app/webapp/node_modules
...
docker run --rm -v ${PWD}/staticfiles:/var/app/staticfiles -t iwebapp/builder rm -rf /var/app/staticfiles/rest_framework
